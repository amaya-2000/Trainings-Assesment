...
import 'package:terminal/Questionfour.dart';

class QuestionqThreeScreen extends StatelessWidget {
  const QuestionqThreeScreen({super.key});
  @override
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const QuestionqFourScreen()));
            },
            child: Container(
              height: 50,
              width: 290,
