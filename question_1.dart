              ...
              Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                ...
                Column(children: [
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      const Padding(
                        padding: EdgeInsets.only(left: 10, top: 26, right: 12),
                        child: Text(
                          'Which of the following is the correct file extension',
                          style: TextStyle(
                              color: Color.fromRGBO(238, 86, 2, 1),
                              fontSize: 12,
                              fontFamily: 'Nunito',
                      ...
                      const Padding(
                        padding: EdgeInsets.only(left: 10, right: 188),
                        child: Text(
                          'for a Python script?',
                          style: TextStyle(
                              color: Color.fromRGBO(238, 86, 2, 1),
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const QuestionTwoScreen()));
                  },
                  child: Container(
                    height: 39,
                    width: 288,
