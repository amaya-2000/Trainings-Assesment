...
import 'package:terminal/Questionthree.dart';

class QuestionqTwoScreen extends StatelessWidget {
  const QuestionqTwoScreen({super.key});
                ...
                child: Column(children: [
                  ...
                  Column(
                    children: [
                      Container(
                        height: 360,
                        width: 360, // Use 90% of screen width
                        decoration: BoxDecoration(
                                ...
                                Expanded(
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            const EdgeInsets.only(left: 212),
                                        child: Container(
                                          height: 30,
                                          width: 88,
                                          decoration: BoxDecoration(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const QuestionqThreeScreen()));
            },
            child: Container(
              height: 50,
              width: 290,
